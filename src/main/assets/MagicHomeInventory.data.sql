...
INSERT INTO Category
	...
	UNION SELECT   100,  110,     'category_boxes',                      'category_box'
	UNION SELECT   100,  120,     'category_packaging',                  'category_box'
	UNION SELECT   100,  130,     'category_containers',                 'category_box'
	UNION SELECT   100,  140,     'category_containers_bulk',            'category_box'
	UNION SELECT   100,  150,     'category_cases',                      'category_box'
	...
	UNION SELECT   700,  710,     'category_sport_accessories',          'category_soccer'
	UNION SELECT   700,  720,     'category_sport_equipment',            'category_soccer'
	UNION SELECT   700,  730,     'category_camping',                    'category_car_front'
	...
	UNION SELECT   800,  810,     'category_toys_soft',                  'category_teddy'
	UNION SELECT   800,  820,     'category_toys_figures',               'category_teddy'
	UNION SELECT   800,  830,     'category_toys_tabletop',              'category_teddy'
	UNION SELECT   800,  840,     'category_toys_puzzlers',              'category_teddy'
	UNION SELECT   800,  850,     'category_toys_construction',          'category_teddy'
	UNION SELECT   800,  860,     'category_toys_outdoors',              'category_teddy'
	UNION SELECT  NULL,  900, 'category_electronics',                    'category_plug'
	UNION SELECT   900,  910,     'category_appliances',                 'category_plug'
	UNION SELECT   910,  911,         'category_appliances_major',       'category_plug'
	UNION SELECT   910,  912,         'category_appliances_minor',       'category_plug'
	UNION SELECT   910,  913,         'category_electronic_parts',       'category_plug'
	UNION SELECT   900,  920,     'category_recorders',                  'category_plug'
	UNION SELECT   900,  930,     'category_playbacks',                  'category_disc'
	UNION SELECT   900,  940,     'category_displays',                   'category_plug'
	UNION SELECT   900,  950,     'category_computers',                  'category_chip'
	UNION SELECT   900,  960,     'category_computer_peripherals',       'category_chip'
	UNION SELECT   900,  970,     'category_cables',                     'category_plug'
	UNION SELECT  NULL, 1000, 'category_tools',                          'category_tools'
	UNION SELECT  1000, 1010,     'category_diy',                        'category_tools'
	UNION SELECT  1000, 1020,     'category_gardening',                  'category_tools'
	UNION SELECT  1000, 1030,     'category_craft',                      'category_tools'
	UNION SELECT  1000, 1040,     'category_materials',                  'category_tools'
	UNION SELECT  1000, 1050,     'category_chemicals',                  'category_tools'
	UNION SELECT  NULL, 1100, 'category_stationery',                     'category_paper'
	UNION SELECT  1100, 1110,     'category_stationery_desktop',         'category_paper'
	UNION SELECT  1100, 1120,     'category_stationery_paper',           'category_paper'
	UNION SELECT  1100, 1130,     'category_stationery_art',             'category_pen'
	UNION SELECT  1100, 1140,     'category_stationery_storage',         'category_box'
	UNION SELECT  NULL, 1200, 'category_documents',                      'category_paper'
	UNION SELECT  1200, 1210,     'category_archives',                   'category_paper'
	UNION SELECT  1200, 1220,     'category_statements',                 'category_paper'
	UNION SELECT  1200, 1230,     'category_manuals',                    'category_paper'
	...
	UNION SELECT  1400, 1430,     'category_sanitation',                 'category_foods'
	UNION SELECT  1400, 1440,     'category_cleaning',                   'category_tools'
	UNION SELECT  1400, 1450,     'category_utensils_kitchen',           'room_kitchen'
	UNION SELECT  1400, 1460,     'category_cookware',                   'room_kitchen'
	UNION SELECT  1400, 1470,     'category_tableware',                  'room_kitchen'
;
