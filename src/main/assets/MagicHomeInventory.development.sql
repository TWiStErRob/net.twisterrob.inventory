...
INSERT INTO Room_Rooter(_id, property, type, name) VALUES(4, 1, 201, 'Spajz');
	INSERT INTO Item(_id, parent, category, name) VALUES(100005, (select root from Room where _id = 4), 3100, 'Papirdoboz kek karikakkal');
		...
		INSERT INTO Item(_id, parent, category, name) VALUES(100011, 100005, 6400, 'Neon pohar 5');
		INSERT INTO Item(_id, parent, category, name) VALUES(100012, 100005, 6400, 'Neon pohar 6');
		INSERT INTO Item(_id, parent, category, name) VALUES(100013, 100005, 6400, 'Neon pohar 7');
		INSERT INTO Item(_id, parent, category, name) VALUES(100014, 100005, 6400, 'Neon pohar 8');
		INSERT INTO Item(_id, parent, category, name) VALUES(100015, 100005, 6400, 'Neon pohar 9');
