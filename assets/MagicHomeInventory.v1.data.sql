...
INSERT INTO Category
	...
	UNION SELECT  2000,     -1, 'category_luggage',                        'category_unknown'
	UNION SELECT  2100,   2000,     'category_luggage_backpacks',          'category_unknown'
	UNION SELECT  2200,   2000,     'category_luggage_bags',               'category_unknown'
	UNION SELECT  2300,   2000,     'category_luggage_suitcases',          'category_unknown'
	UNION SELECT  2400,   2000,     'category_luggage_trunks',             'category_unknown'
	UNION SELECT  3000,     -1, 'category_storage',                        'category_unknown'
	UNION SELECT  3100,   3000,     'category_storage_boxes',              'category_unknown'
	UNION SELECT  3200,   3000,     'category_storage_baskets',            'category_unknown'
	UNION SELECT  3300,   3000,     'category_storage_crates',             'category_unknown'
	UNION SELECT  3400,   3000,     'category_storage_disccases',          'category_unknown'
	UNION SELECT  4000,     -1, 'category_collectibles',                   'category_unknown'
	UNION SELECT  4100,   4000,     'category_collectible_albums',         'category_unknown'
	UNION SELECT  4200,   4000,     'category_collectible_artwork',        'category_unknown'
	UNION SELECT  4300,   4000,     'category_collectible_antiques',       'category_unknown'
	UNION SELECT  4400,   4000,     'category_collectible_magazines',      'category_unknown'
	UNION SELECT  4500,   4000,     'category_collectible_books',          'category_unknown'
	UNION SELECT  4600,   4000,     'category_collectible_recordings',     'category_unknown'
	UNION SELECT  4610,   4600,         'category_collectible_cds',        'category_unknown'
	UNION SELECT  4620,   4600,         'category_collectible_dvds',       'category_unknown'
	UNION SELECT  4630,   4600,         'category_collectible_blurays',    'category_unknown'
	UNION SELECT  4640,   4600,         'category_collectible_tapes',      'category_unknown'
	UNION SELECT  4700,   4000,     'category_collectible_souvenirs',      'category_unknown'
	...
	UNION SELECT  6000,     -1, 'category_kitchenware',                    'category_unknown'
	UNION SELECT  6100,   6000,     'category_kitchen_cutlery',            'category_unknown'
	UNION SELECT  6200,   6000,     'category_kitchen_dishes',             'category_unknown'
	UNION SELECT  6300,   6000,     'category_kitchen_pans',               'category_unknown'
	UNION SELECT  6400,   6000,     'category_kitchen_glasses',            'category_unknown'
...
INSERT INTO Category
	...
	UNION SELECT 11000,     -1, 'category_stationery',                     'category_unknown'
	UNION SELECT 11100,  11000,     'category_stationery_painting',        'category_unknown'
	UNION SELECT 11200,  11000,     'category_stationery_drawing',         'category_unknown'
	UNION SELECT 11300,  11000,     'category_stationery_writing',         'category_unknown'
	UNION SELECT 11400,  11000,     'category_stationery_paper',           'category_unknown'
	...
	UNION SELECT 14000,     -1, 'category_documents',                      'category_unknown'
	UNION SELECT 14100,  14000,     'category_document_archives',          'category_unknown'
	UNION SELECT 14200,  14000,     'category_document_statements',        'category_unknown'
	...
	UNION SELECT 16000,     -1, 'category_electronics',                    'category_unknown'
	UNION SELECT 16100,  16000,     'category_electronic_appliances',      'category_unknown'
	UNION SELECT 16200,  16000,     'category_electronic_cables',          'category_unknown'
	UNION SELECT 16300,  16000,     'category_electronic_recorders',       'category_unknown'
	UNION SELECT 16400,  16000,     'category_electronic_playbacks',       'category_unknown'
	UNION SELECT 16500,  16000,     'category_electronic_displays',        'category_unknown'
	UNION SELECT 16510,  16500,         'category_electronic_monitors',    'category_unknown'
	UNION SELECT 16520,  16500,         'category_electronic_tv',          'category_unknown'
	UNION SELECT 16530,  16500,         'category_electronic_projector',   'category_unknown'
	UNION SELECT 16600,  16000,     'category_computers',                  'category_unknown'
	UNION SELECT 16610,  16600,         'category_computer_components',    'category_unknown'
	UNION SELECT 16620,  16600,         'category_computer_peripherials',  'category_unknown'
	UNION SELECT 16630,  16600,         'category_computer_datastorage',   'category_unknown'
	UNION SELECT 16700,  16000,     'category_computer_gameconsoles',      'category_unknown'
