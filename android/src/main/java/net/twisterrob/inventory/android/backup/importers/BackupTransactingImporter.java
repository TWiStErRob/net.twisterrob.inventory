...
public class BackupTransactingImporter<T> implements ZipImporter<T> {
	...
	public BackupTransactingImporter(ZipImporter<T> importer, ImportProgressHandler progress) {
		this(importer, progress, App.db());
	}
	@VisibleForTesting BackupTransactingImporter(ZipImporter<T> importer, ImportProgressHandler progress, Database db) {
