 ...
 */
public class GlideExecutorIdlingResource implements IdlingResource, Runnable {
	private static final Logger LOG = LoggerFactory.getLogger(GlideExecutorIdlingResource.class);
